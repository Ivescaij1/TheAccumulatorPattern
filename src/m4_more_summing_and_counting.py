...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(0, 1, 0.1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(7, 7, 0.7)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 4
    answer = count_cosines_from(10, 20, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 7
    answer = count_cosines_from(30, 45, 0.3)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 9
    answer = count_cosines_from(30, 60, 0.6)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.1
    answer = sum_unit_fractions_from(10, 10)
